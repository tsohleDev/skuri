...
class ShipmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shipment" do
    assert_difference("Shipment.count") do
      post shipments_url, params: { shipment: { customer_id: @shipment.customer_id, order_id: @shipment.order_id, shipment_service: @shipment.shipment_service } }
    end
  ...
  test "should update shipment" do
    patch shipment_url(@shipment), params: { shipment: { customer_id: @shipment.customer_id, order_id: @shipment.order_id, shipment_service: @shipment.shipment_service } }
